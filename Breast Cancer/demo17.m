function [bestk,bestw,ACL,clusterid,NMI,ACL_vec,k_vec]=demo17()
% this is demo10.m a function tests differnet algorithms in estimating the number
% of clusters of the Breast Cancer Balanced data set.
%
